...
map("n", "<leader>lws", function() require("telescope.builtin").lsp_document_symbols({}) end)
map("n", "<leader>lD", function() require("telescope.builtin").diagnostics({}) end)
map("n", "<leader>lcd", function() require("telescope.builtin").diagnostics({ bufnr = 0 }) end)
